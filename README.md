...
| `labels.parquet` | `138,941` | Binary settlement outcomes, with a `source` column |
...
So "has a label" correlates strongly with "settled before Jul 24" — 35,233
markets (21%) carry an authoritative label, and they are **not a random 21%**.
